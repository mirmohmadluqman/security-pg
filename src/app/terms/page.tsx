                ...
                <div className="glass p-8 md:p-12 rounded-[32px] border-white/5 space-y-10 leading-relaxed">
                    <section className="space-y-4">
                        ...
                        <p className="text-slate-300">
                            Security Playground is an open-source educational tool. All content, simulations, and attack scenarios are provided <span className="text-white font-semibold">solely for learning and research</span>. Use of this platform to facilitate unauthorized access to real-world systems is strictly prohibited.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-slate-300">
                            The platform is provided "as is" without any warranties. The developers of Security Playground are <span className="text-white font-semibold">not responsible for any direct or indirect damage</span> or legal repercussions resulting from the use or misuse of the information provided herein.
                        </p>
                    </section>
